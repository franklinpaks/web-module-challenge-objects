...
console.log("Task 1A: ", createMenuItem("Nachos", 5, "Lunch"));
...
console.log("Task 1B: ", createMenuItem("Fried Rice", 7, "Dinner"));
console.log("Task 1B: ", createMenuItem("Mac n Cheese", 5, "Lunch"));
...
const burger = {
  ...
  discount: function(person) {
    if(person === 'teacher' || person ==="student" ) {
      ...
      return 'There are no discounts available for you!';
    }
  }
}
